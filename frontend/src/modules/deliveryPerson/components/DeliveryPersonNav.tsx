...
import type { UserInfo } from "../../user/types/UserInfo";
import { FaSearch, FaUserCircle, FaShoppingCart } from "react-icons/fa";

const userService = new UserService();

export const DeliveryPersonNav = () => {
            ...
            {cartOpen && (
                <>
                    <div
                        ...
                        onClick={closeCart}
                    />
                    <div className="fixed right-0 top-0 w-96 h-screen bg-white shadow-2xl z-50 p-6 overflow-auto transform transition-transform duration-300">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-700">Meu Carrinho</h2>
                            <button onClick={closeCart} className="text-gray-500 hover:text-gray-700 text-2xl cursor-pointer">×</button>
                        </div>
